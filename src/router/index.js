...
export default new Router({
	...
	routes: [{ /* 登录页面 */
		...
		{ /* 主页 */
			...
			children: [{ /* 图形化 */
				...
				{ /* 产品档案登记复核-复核页面 */
					...
					component: ProductReview_info => require(['@/components/productDesign/management/ProductReview-info.vue'],
						ProductReview_info)
				},
				{ /* 产品档案查询、更改、删除 */
					path: '/ProductFileChange',
					name: 'ProductFileChange',
					component: ProductFileChange => require(['@/components/productDesign/management/ProductFileChange.vue'],
						ProductFileChange)
				},
				{ /* 产品档案查询、更改、删除-查询 */
				...
				{ /* 物料组成设计单审核-审核页面*/
					...
					component: MaterialReviewInfo => require(['@/components/productDesign/material/MaterialReview-info.vue'],
						MaterialReviewInfo)
				},
				{ /* 产品生产工序设计单审核 */
					path: '/Processdesign',
				...
				{ /* 生产计划审核 */
					...
					component: Productionplanreview => require(['@/components/Production/ProductionPlan/Productionplanreview.vue'],
				...
				{ /* 产品档案查询-永久删除-恢复*/
					...
					component: ProductFileDelete => require(['@/components/productDesign/management/ProductFileDelete.vue'],
						ProductFileDelete)
				},
				{ /* 生产派工单审核 */
					path: '/Workorder',
				...
				{ /* 生产登记复核-审核页面*/
					...
					component: ProductionregisterInfo => require(['@/components/Production/internal/Productionregister-info.vue'],
						ProductionregisterInfo)
				},
				{ /* 生产登记复核-审核页面-表单详情*/
					path: '/Productionregister-info2',
					name: 'Productionregister-info2',
					component: ProductionregisterInfo2 => require(['@/components/Production/internal/Productionregister-info2.vue'],
				...
				{ /* 产品生产工序设计单查询-查看-变更*/
					...
					component: ProductProcessChange => require(['@/components/Production/process/ProductProcessChange.vue'],
				...
				{ /* 产品生产工序设计单查询-变更*/
					...
					component: ProductProcessChanges => require(['@/components/Production/process/ProductProcessChanges.vue'],
				...
				{ /* 生产计划管理-查询*/
					...
					component: ProductionPlanSelect => require(['@/components/Production/ProductionPlan/ProductionPlanSelect.vue'],
				...
				{ /* 生产查询-s*/
					...
					component: ProductionSelectInfo => require(['@/components/Production/internal/ProductionSelect-info.vue'],
				...
				{ /* 入库查询-s*/
					...
					component: WarehouseQueriesInfo => require(['@/components/inventory/enterAdmin/WarehouseQueries-info.vue'],
				...
				{ /* 入库登记复核-审核页面*/
					...
					component: JoinbankregisterInfo => require(['@/components/inventory/enterAdmin/Joinbankregister-info.vue'],
				...
				{ /* 出库申请登记审核-审核页面*/
					...
					component: OutbankregisterInfo => require(['@/components/inventory/comeoutAdmin/Outbankregister-info.vue'],
						OutbankregisterInfo)
				},
				{ /* 出库查询*/
					path: '/OutboundQuery',
				...
				{ /* 动态库存查询*/
					...
					component: DynamicInventorySelect => require(['@/components/inventory/dynamic/DynamicInventorySelect.vue'],
        ...
        { /*产品供应商推荐登记--变更 */
        	path: '/changes1',
        	name: 'changes1',
        	component: changes1 => require(['@/components/procurement/recommend/changes1.vue'],
        		changes1)
        },
        { /*产品供应商推荐登记--变更 */
        	path: '/changes2',
