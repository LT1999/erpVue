		...
		<div id="card">
			<el-card class="box-card">
				<div style="padding-bottom: 10px; ">
					<span style="font-size: 20px;color: #6275A6;">生产派工单审核</span>
					
					<br />
					<span style="font-size: 12px;color: #C6C6C9;">当前等待审核的生产派工单总数 :({{tableData.length}})例 </span>
				...
				<div id="table" style="">
					<el-table id="" :data="tableData" border stripe style="width: 100%" stripe>
						...
						<el-table-column prop="designer" label="工单制定人" width="150px">
						</el-table-column>
...
<script>
	export default {
		...
		methods: {
			...
			initialize(){
				this.$http.post("http://localhost:8080/Erp-web/manufacture/selectNoCheck.do")
					.then(res => {
