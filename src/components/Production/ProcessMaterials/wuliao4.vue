	...
	<div id="box">
		<div id="head">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item>工序物料设计单</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		...
		<div id="card">
			<el-form ref="form" :model="form" label-width="130px">
				<div id="buttons">
					<el-button size="mini" type="primary" plain @click="redesign()">重新设计</el-button>
...
<script>
	export default {
		...
		methods: {
			...
			redesign() {
				this.$confirm('此操作将清除本道工序已设计的工序物料, 是否继续?', '提示', {
			...
			delete(){
				this.$set(this.designProcedureModule,'designProcedureModuleList',this.tableData);
				console.log(this.designProcedureModule);
				this.$http.post("http://localhost:8080/Erp-web/design-procedure-module/deleteDesignProcedureModule.do",this.$qs.stringify(this.designProcedureModule,{arrayFormat: 'designProcedureModuleList', allowDots: true}))
				.then(res => {
						if(res.data>0){
