	...
	<div id="box">
		<div id="head">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item>工序物料设计单变更</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
					...
					<el-row>
						<template>
							<el-table :data="tableData" style="margin-left: 8%; width: 80%;" border>
								...
								<el-table-column prop="wid" label="物料编号">
								</el-table-column>
								<el-table-column prop="miaoshu" label="描述 ">
								</el-table-column>
								<el-table-column prop="count" label="本工序数量">
								</el-table-column>
								<el-table-column prop="danwei" label="单位 ">
								</el-table-column>
								<el-table-column prop="money" label="单价(元) ">
								</el-table-column>
								<el-table-column prop="moneys" label="小计(元) ">
								</el-table-column>
							</el-table>
						</template>
					</el-row>
					<el-row><span style="margin-left: 500px;color: red;">变更前将清除本工序物料设计，变更后需要对其他工序进行物料设计，请谨慎操作</span></el-row>
				</el-card>
			</el-form>
		</div>
...
<script>
	export default {
		...
		methods: {
			//返回
			back() {
				location.href = "#/MaterialDesignChanges"
			}
		}
	}
</script>
