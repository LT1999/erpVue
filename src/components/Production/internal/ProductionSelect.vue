	...
	<div id="box">
		<el-card shadow="always">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item>生产查询</el-breadcrumb-item>
			</el-breadcrumb>
			<br />
			<div id="body">
				<form>
						...
						<tr>
							...
							<td colspan="5">
								<el-checkbox-group>
									...
									<el-button @click="open" type="primary" class="btn2" style="margin-left:480px;">查询</el-button>
								</el-checkbox-group>
							</td>
						</tr>

						<tr>
							<td class="txt">请输入派工单编号</td>
							<td>
			...
			<div>
				<el-table :data="tableData" style="width: 100%">
					<el-table-column prop="designorderid" label="派工单编号">
					</el-table-column>
					<el-table-column prop="productid" label="产品编号">
					</el-table-column>
					<el-table-column prop="productname" label="产品名称">
					</el-table-column>
					<el-table-column prop="newtime" label="数量">
					</el-table-column>
					<el-table-column prop="money" label="合格品数量">
					</el-table-column>
					<el-table-column prop="designorderstate" label="派工单状态">
					</el-table-column>
					<el-table-column prop="designorderstate" label="生产状态">
					</el-table-column>
...
<script>
	export default {
		...
		methods: {
			//查看
			back(){
				location.href="#/ProductionSelectInfo"
			},
			//分页
