	...
	<div id="box">
		<div id="head">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item :to="{path:'/'}">出库管理
				</el-breadcrumb-item>
					...
					<el-row>
						<template>
							<el-table :data="tableData" style="margin-left: 8%; width: 80%;" border>
								...
								<el-table-column prop="amount" label="应出库数量 ">
								</el-table-column>
								<el-table-column prop="amount" label="已出库数量">
								</el-table-column>
								<el-table-column prop="subtotal" label="应出库小计">
								</el-table-column>
								<el-table-column prop="subtotal" label=" 已出库小计 ">
								</el-table-column>
...
<el-drawer title="出库单明细" :visible.sync="drawer" :with-header="false" :size="size">
			<el-table :data="gridData">
				<template>
					...
					<el-table-column prop="materialprice" label="出库时间 "></el-table-column>
					<el-table-column property="name" label="本次出库数量"></el-table-column>
					<el-table-column property="describe" label="本次出库成本"></el-table-column>
