	...
	<div id="box">
		...
		<div id="card">
			<el-form ref="form" :model="form" label-width="130px">
				<div id="buttons">
          <el-button size="mini" type="warning" plain @click="updateNotapproved">审核不通过</el-button>
          <el-button size="mini" type="success" plain @click="updateapprove">审核通过</el-button>
				...
				<el-card class="box-card">
					...
					<el-row>
						...
						<el-col :span="8" :push='5'>
							<el-form-item label="设置B/N或S/N">
								<el-select v-model="bs" style="width:  170px;" clearable placeholder="请选择">
									<el-option label="否" value="0"></el-option>
									<el-option label="设置B/N" value="1"></el-option>
									<el-option label="设置S/N" value="2"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
					</el-row>
					...
					<template>
						<el-table :data="tableData" style="margin-left: 8%; width: 85%;" border>
							<el-table-column prop="no" v-model="form.storeId" label="序号">
							</el-table-column>
							<el-table-column prop="name" label="库房名称">
							</el-table-column>
							<el-table-column prop="addressno" label="存储地址编号">
							</el-table-column>
							<el-table-column prop="addressname" label="存储地址名称">
							</el-table-column>
							<el-table-column prop="shortname" label="存储单元简称">
					...
					<el-row>
						<el-col :span="21" :push='1'>
							<el-form-item label="配置要求" style="width: 100%;">
								<el-input style="width: 100%;" v-model="form.config" type="textarea" :autosize="{ minRows: 4, maxRows: 6}" placeholder="请输入内容">
								</el-input>
							</el-form-item>
						</el-col>
					</el-row>
