	...
	<div id="box">
		<el-card shadow="always">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item>安全库存配置单查询</el-breadcrumb-item>
			</el-breadcrumb>
			<br />
			<div id="body">
				<form>
			...
			<div>
				<span>
				等待执行的配置单总数：{{num1}}例, 正在执行的配置单总数：{{num2}}例, 完成的配置单总数：{{num3}}例
				</span>
			</div>
			<hr />
			<div>
				<el-table :data="tableData" style="width: 100%">
					<el-table-column prop="id" label="配置单编号">
					</el-table-column>
					<el-table-column prop="productId" label="产品编号">
					</el-table-column>
					<el-table-column prop="productName" label="产品名称">
					</el-table-column>
					<el-table-column prop="checkTag" label="配置单状态">
					</el-table-column>
    ...
    created() {
      this.selectCellAll();
		...
		methods: {
			//查看
			back(){
				location.href="#/InventoryConfigurationChangeInfo"
			},
			//变更
			back2(){
				location.href="#/InventoryConfigurationChanges"
			},
			//分页
      ...
      selectCellAll(){//selectCellAll
          this.$http.post("http://localhost:8080/Erp-web/cell/selectCellAll.do")
            		.then(res => {
