	...
	<div id="box">
		<el-card shadow="always">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item>入库申请查询</el-breadcrumb-item>
			</el-breadcrumb>
			<br />
			<div id="body">
				<form>
			...
			<div>
				<el-table :data="tableData" style="width: 100%">
					<el-table-column prop="gatherId" label="申请单编号">
					</el-table-column>
			...
			<div class="block">
				<el-pagination style="margin-top: 10px;" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage" :page-sizes="[5, 7, 9]" :page-size="3" layout="total, sizes, prev, pager, next, jumper" :total="10">
				</el-pagination>
			</div>
		</el-card>
	</div>
    ...
    created() {
      this.selectGather();
		...
		methods: {
			...
			back(index,row){
        this.$router.push({
        	path: '/WarehousingApplicationSelectInfo',query:{id:row.id,gatherId:row.gatherId,storer:row.storer,register:row.register,remark:row.remark,checkTag:row.checkTag,checker:row.checker,checkTime:row.checkTime,
