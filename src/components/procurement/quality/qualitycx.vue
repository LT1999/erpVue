         ...
         <el-card class="box-card">
              <div>
              	<el-table :data="tableData" style="width: 100%">
              		<el-table-column prop="payId" label="执行单编号">
              		</el-table-column>
              		<el-table-column prop="reason" label="产品编号">
              		</el-table-column>
                  <el-table-column prop="reason" label="产品名称">
                  </el-table-column>
              		<el-table-column prop="registerTime" label="采购数量">
              		</el-table-column>
                  <el-table-column prop="registerTime" label="已收合格数量">
                  </el-table-column>
              		<el-table-column prop="amountSum" label="未收数量">
              		</el-table-column>
