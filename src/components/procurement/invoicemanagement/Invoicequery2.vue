<template>
   ...
   <div id="card">
          ...
          <span style="font-size: 12px;padding-left: 30px; color: black">执行单编号 :{{pno}} </span>
          <span style="font-size: 12px;padding-left: 50px; color: black">其中收发票状态 :{{zt}} </span>
              ...
              <el-table-column prop="no" label="序号">
							...
							<el-table-column prop="no" label="供应商名称">
							</el-table-column>
              ...
              <el-table-column prop="phone" label="电话">
							...
							<el-table-column prop="addressno" label="应开票金额">
							</el-table-column>
							<el-table-column prop="addressname" label="已收到金额">
							</el-table-column>
							<el-table-column prop="shortname" label="本次收到金额">
							</el-table-column>
