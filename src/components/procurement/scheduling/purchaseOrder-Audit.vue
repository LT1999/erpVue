	...
	<div id="box">
		<el-card shadow="always">
			...
			<el-table :data="tableData" border>
				<el-table-column prop="designorderid" label="采购执行单编号">
				</el-table-column>
				...
				<el-table-column prop="money" label="执行单登记时间">
				</el-table-column>
				
				<el-table-column prop="assembletable" label="操作">
					<template slot-scope="scope">
						<el-button type="text">
							<el-button type="text" @click="back">审核</el-button>
						</el-button>
					</template>
				</el-table-column>
			</el-table>
...
<script>
	export default {
		...
		methods: {
			//查看
			back() {
				location.href = "#/purchaseOrderAuditinfo "
			},
			//分页
