		...
		<div id="card">
			<el-form ref="form" :rules="rules" :model="form" label-width="130px">
				<div id="buttons">
					...
					<el-button type="warning" @click="submit()">未通过</el-button>
				...
				<el-card class="box-card">
					...
					<el-row>
						<template>
							<el-table :data="tableData" style="margin-left: 8%; width: 85%;" border>
								...
								<el-table-column prop="8" label="折扣(%) ">
									<input v-model="input"></input>
								</el-table-column>
							</el-table>
						</template>
					...
					<el-row>
						<el-col :span="8" :push='1'>
							<el-form-item label="审核人" prop="changer">
								<input v-model="input"></input>
							</el-form-item>
						</el-col>
						<el-col :span="8" :push='6'>
							<el-form-item label="审核人编号" prop="changerid">
							<input v-model="input"></input>
							</el-form-item>
						</el-col>
					</el-row>
